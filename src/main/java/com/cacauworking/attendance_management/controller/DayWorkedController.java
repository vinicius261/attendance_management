...
public class DayWorkedController {
    ...
    public List<DayWorked> findDaysByEmployee(@PathVariable String documentoFuncionario){
        return service.findAllByEmployee(attendanceManagementService.findByEmployee(documentoFuncionario));
    }
}
